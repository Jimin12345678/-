...
def main():
    ...
    st.set_page_config(page_title="속담왕", page_icon="🏅")  # 웹 페이지 제목과 아이콘 설정
    st.image('재미있는.png')  # 상단에 이미지를 표시
    st.title("_:yellow[속담과 관용표현 도우미]_ 🏫")  # 제목 표시 (에너지 학습 도우미)
    st.header("✨속담과 관용표현의 뜻을 검색하세요✨", divider='rainbow')  # 주의사항 표시
